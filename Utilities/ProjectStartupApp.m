classdef ProjectStartupApp < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        GitHubRepository = "Vector-Arithmetic";
    end
...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Welcome to Vector Arithmetic';
            ...
            app.Image.ImageSource = 'cellPhoneTiltLabels.png';
            ...
            app.ReviewTitle.Text = 'Welcome to Vector Arithmetic';
